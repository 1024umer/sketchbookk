                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/art1.jpg"><img class="product__media--preview__items--img" src="assets/img/product/art1.jpg" alt="product-media-img"></a>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="{{asset('storage/'.$item->url)}}" alt="product-nav-img">
                                    </div>
                                    @endforeach
                                </div>
                            </div>
