                    ...
                    <div class="col">
                        <div class="breadcrumb__content">
                            ...
                            <ul class="breadcrumb__content--menu d-flex">
                                <li class="breadcrumb__content--menu__items"><a class="text-white" href="{{ route('dashboard') }}">Home</a>
                                </li>
                        ...
                        <div class="col-lg-7">
                            <div class="contact__form">
                                ...
                                <form class="contact__form--inner" action="{{route('contact.store')}}" method="POST">
                                    ...
                                    <button disabled id="submitBtn" class="contact__form--btn primary__btn" type="submit">Submit Now</button>
                                    @if(session('error'))
