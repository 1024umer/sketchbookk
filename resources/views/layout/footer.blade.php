...
<footer class="footer__section footer__bg color-scheme-2">
    <div class="container">
        ...
        <div class="footer__bottom d-flex justify-content-between align-items-center">
            <p class="copyright__content">Copyright © 2023 <a class="copyright__content--link" href="index.php">Sketchbook Online</a> . All Rights Reserved.</p>
            <div class="footer__payment text-right">
                <img class="footer__payment--visa__card display-block" src="{{asset('front/img/other/payment-visa-card.webp')}}" alt="visa-card">
            </div>
        </div>
    </div>
</footer>
            ...
            <div class="row row-cols-lg-2 row-cols-md-2">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{asset('front/img/product/art1.jpg')}}"><img class="product__media--preview__items--img" src="assets/img/product/art1.jpg" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="assets/img/product/art1.jpg" data-gallery="product-media-preview">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product2.webp"><img class="product__media--preview__items--img" src="{{asset('front/img/product/big-product2.webp')}}" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product3.webp"><img class="product__media--preview__items--img" src="{{asset('front/img/product/big-product3.webp')}}" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/big-product4.webp"><img class="product__media--preview__items--img" src="{{asset('front/img/product/big-product4.webp')}}" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/product/art1.jpg"><img class="product__media--preview__items--img" src="{{asset('front/img/product/art1.jpg')}}" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="assets/img/product/art1.jpg" data-gallery="product-media-preview">
                                                <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512">
                                                    <path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="{{asset('front/img/product/art1.jpg')}}" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="product__media--nav__items">
                ...
                <div class="col">
                    <div class="quickview__info">
                        <form action="#">
                            <h2 class="product__details--info__title mb-15">Art 1</h2>
                            ...
                            <div class="product__variant">
                                ...
                                {{-- <div class="quickview__variant--list variant__wishlist mb-15">
                                    <a class="variant__wishlist--icon" href="{{route('user.wishlist')}}" title="Add to wishlist">
    ...
    <div class="newsletter__popup--inner">
        ...
        <div class="box newsletter__popup--box d-flex align-items-center">
            <div class="newsletter__popup--thumbnail">
                <img class="newsletter__popup--thumbnail__img display-block" src="{{asset('front/img/banner/newsletter-popup-thumb2.png')}}" alt="newsletter-popup-thumb">
            </div>
...
<!-- Scroll top bar -->
<button class="color-scheme-2" aria-label="scroll top btn" id="scroll__top"><svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
