<header class="header__section header__transparent color-scheme-2">
                        ...
                        <nav class="header__menu--navigation">
                            <ul class="d-flex justify-content-center">
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="{{ route('dashboard') }}">Home</a>
                                </li>
                ...
                <div class="main__header--inner d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.php"><img
                                    class="main__logo--img" src="{{ asset('front/img/logo/logo-clr.svg') }}"
                                    alt="logo-img"></a>
                        </h1>
                    </div>
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="index.php">
                        <img src="{{ asset('front/img/logo/logo-clr.svg') }}" alt="Sketchbook Online Logo">
                    </a>
                        ...
                        <ul class="d-flex align-items-center">
                            <li class="language__currency--list">
                                <a class="offcanvas__language--switcher" href="#">
                                    <img class="language__switcher--icon__img"
                                        src="{{ asset('front/img/icon/language-icon.webp') }}" alt="currency">
                                    <span>English</span>
                            ...
                            <li class="language__currency--list">
                                <a class="offcanvas__account--currency__menu" href="#">
                                    <img src="{{ asset('front/img/icon/usd-icon.webp') }}" alt="currency">
                                    <span>$ US Dollar</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="11.797" height="9.05"
                                        viewBox="0 0 9.797 6.05">
                                        <path d="M14.646,8.59,10.9,12.329,7.151,8.59,6,9.741l4.9,4.9,4.9-4.9Z"
        ...
        <div class="offCanvas__minicart color-scheme-2" tabindex="-1">
            ...
            <div class="minicart__amount">
                <div class="minicart__amount_list d-flex justify-content-between">
                    <span>Sub Total:</span>
                    <span class="total_price"><b>$300.00</b></span>
                </div>
                <div class="minicart__amount_list d-flex justify-content-between">
                    <span>Total:</span>
                    <span class="total_price"><b>$300.00</b></span>
    ...
    @push('js')
        <script>
            $(document).ready(function(){
                $.ajax({
                    type: 'GET',
                    url: `{{route('cart.count')}}`, // Create a route for this endpoint
                    success: function (data) {
                        var cartCount = data.cartCount;
                        // Update the cart icon with the cartCount value
                        $('.items__count').text(cartCount); // Update the cart count in your cart icon element
                    },
                    error: function (data) {
            ...
            $('.minicart__open--btn').click(function(){
                $.ajax({
                    type:'GET',
            ...
            function products(data){
                ...
                var minicartHtml = ''; // Create an empty HTML variable
                var total = 0;
                list.forEach(product => {
                    var imageUrl = product.url;
                    minicartHtml += `
                        <div class="minicart__product--items d-flex">
                            <div class="minicart__thumbnail">
                                <a href="product-details.php"><img src="${imageUrl}" alt="prduct-img"></a>
                            </div>
                            <div class="minicart__text">
                                <h4 class="minicart__subtitle"><a href="product-details.php">${product.title}</a></h4>
                ...
                $('.minicart__product').html(minicartHtml);
